...
const topratedPage = () => {
    ...
    const loadMorePages =async (e:any) => {
      ...
      if(isSearch){
        ...
        const resp = await fetchMoviesByParamsData({now_playing: 'top_rated', page});
        //console.log(resp);
        setPage(page + 1);
        setMovies([...movies, ...resp.results]);
      }
  ...
  return (
    <RootLayouts>
        ...
        <div className='container my-2'>
          <div className='row'>
          <h1 className='text-1xl font-bold mb-4'>Top Rated Movies</h1>
            ...
            <div className='toprated row'>
                ...
                <div className='topratedPages row row row-cols-4 col-md-9'>
                    {
                        isLoading && (
